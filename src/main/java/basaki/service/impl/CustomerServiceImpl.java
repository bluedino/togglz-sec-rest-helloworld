...
/**
 * 
 * <tt>CustomerServiceImpl</tt> is version 1 of the business service class
...
public class CustomerServiceImpl implements CustomerService {
	...
	public Customer updatePartialCustomer(int id, Customer customer) {
		Customer cust = customers.get(id);
		if (cust != null && customer != null) {
			cust.setFirstName(customer.getFirstName() != null ? customer
					.getFirstName() : cust.getFirstName());
			cust.setLastName(customer.getLastName() != null ? customer
					.getLastName() : cust.getLastName());
			...
			if (customer.getAddress() != null) {
				cust.getAddress().setStreet(
						customer.getAddress().getStreet() != null ? customer
								.getAddress().getStreet() : cust.getAddress()
								.getStreet());
				cust.getAddress().setCity(
						customer.getAddress().getCity() != null ? customer
								.getAddress().getCity() : cust.getAddress()
								.getCity());
				cust.getAddress().setState(
						customer.getAddress().getState() != null ? customer
								.getAddress().getState() : cust.getAddress()
								.getState());
				cust.getAddress().setZipCode(
						customer.getAddress().getZipCode() != null ? customer
								.getAddress().getZipCode() : cust.getAddress()
								.getZipCode());
			}
		}
