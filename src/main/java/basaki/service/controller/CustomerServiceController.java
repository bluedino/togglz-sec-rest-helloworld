...
public class CustomerServiceController {
	...
	@RequestMapping(method = RequestMethod.GET, produces = {
			MediaType.APPLICATION_XML_VALUE, MediaType.APPLICATION_JSON_VALUE }, value = "/{id}")
	@ResponseBody
	...
	public CustomerList getCustomers() {
		...
		return new CustomerList(new ArrayList<Customer>(factory.getService()
				.getCustomers()));
	}
	...
	@RequestMapping(method = RequestMethod.PUT, consumes = {
			...
			MediaType.APPLICATION_XML_VALUE, MediaType.APPLICATION_JSON_VALUE }, value = "/{id}")
	public @ResponseBody
	Customer updateCustomer(@PathVariable("id") Integer id,
	...
	Customer updatePartialCustomer(@PathVariable("id") Integer id,
		...
		Customer cust = factory.getService()
				.updatePartialCustomer(id, customer);
